...
const UserProfileForm = ({
  ...
  userSubrole,
  onProfileSaved,
  onClose = () => {}, // Add default function to prevent errors
}) => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        setStatus({
          loading: false,
          message:
            "Could not load your profile. You can still save your information.",
          type: "warning",
        });
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Call the parent callback which will handle the metadata update and redirection
      if (onProfileSaved) {
      ...
      // The timeout and onClose will be managed by the parent component
    ...
    <div className="w-full max-w-xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 p-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-xs">Fill in your details to get started</p>
      ...
      <div className="p-6">
        ...
        {status.message && (
          <div
            className={`mt-4 p-3 rounded-lg text-center font-medium text-sm transition-all duration-300 ${
              status.type === "success"
